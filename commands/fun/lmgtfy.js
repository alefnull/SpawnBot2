...
module.exports = {
  ...
  run(client, msg, args) {
    ...
    const embed = new MessageEmbed().setColor('#0000ee').setTitle('Let Me Google That For You');
    ...
    embed
      ...
      .setThumbnail(
        'https://lmgtfy.app/assets/SERP/lmgtfy_logo-b222a421fb6cf257985abfab188be7d6746866850efe2a800a3e57052e1a2411.png'
      );
